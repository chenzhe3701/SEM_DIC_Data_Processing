...
for iE = 0:6        % 'e#' in the file name, i.e., stop/pause #  ----------------------------------------------
    ...
    for iR = row_start:row_end 
         for iC = col_start:col_end - 1      
            ...
            fName2 = [fileNamePrefix_1,num2str(iE),fileNamePrefix_2,'r',num2str(iR),'c',num2str(iC+1)]; disp(fName2);   % change this accordingly -------------------------------
            ...
            if (iC==col_start)&&(iR<row_end)    % search the down-side picture as well
                ...
                fName3 = [fileNamePrefix_1,num2str(iE),fileNamePrefix_2,'r',num2str(iR+1),'c',num2str(iC)]      % change this accordingly -------------------------------
                I = imread([path_DIC,'\',folderName,'\',fName1,'.tif']);
